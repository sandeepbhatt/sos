...
create table customer (customer_id integer not null auto_increment, customer_date_of_birth date not null, customer_email_address TEXT not null, customer_firstname varchar(50) not null, customer_lastname varchar(50) not null, customer_address_id integer, primary key (customer_id)) ENGINE=InnoDB
